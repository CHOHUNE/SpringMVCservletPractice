...
//     request.getHeader("host"); 헤더 하나만 조회할 떄
    ...
    private void printHeaderUtils(HttpServletRequest request) {
        ...
        //Host 헤더 System.out.println("request.getServerPort() = " +request.getServerPort()); //Host 헤더
        // System.out.println();
        ...
        System.out.println("request.getContentType() = " + request.getContentType()); // get방식은 content를 거의 안보내기 때문에 null 값이 나온다
    ...
    //Http 메세지에 대한 정보는 아니고 내부에서 네트워크 커넥션이 맺어진 정보
